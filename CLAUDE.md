...
**YOU ARE IN: `spectralNotify/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/spectralNotify/` (rig root) or other directories
...
**Your mail address:** `spectralNotify/polecats/rust`
**Your rig:** spectralNotify
**Your Witness:** `spectralNotify/witness`
...
| Ask Witness for help | `gt mail send spectralNotify/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`spectralNotify/witness`) when:
...
```bash
gt mail send spectralNotify/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
